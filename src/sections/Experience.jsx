...
export const Experience = () => {
    return (
        <section id="experience" className="py-32 relative overflow-hidden">
            <div className="absolute top1/2 left-1/4 w-96 h-96 bg-primary/5 rounded-full blur-3xl -translate-y-1/2" />
                ...
                <div className="relative">
                    ...
                    <div className="space-y-12">
                        {experiences.map((exp, idx) => (
                            <div
                                key={idx}
                                className="relative grid md:grid-cols-2 gap-8 animate-fade-in animate"
                                style={{
                                    animationDelay: `${(idx + 1) * 150}ms`,
                                }}
                            >
                                {/* Timeline Dot */}
                                <div className="absolute left-0 md:left-1/2 top-0 w-3 h-3 bg-primary rounded-full md:-translate-x-1 -translate-x-1/2 ring-4 ring-background z-10">
                                    {exp.current && (
